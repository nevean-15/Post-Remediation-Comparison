...
MRH_SESSION = "11b8d856815888bae845bb6e01d2c569" ## Session ID (This will be changed once moved to ORC Probably)
#XXX
...
sheet_name = "Malware_NW_1590418.csv"
# m_job_id = "1478723"  ## From MSV 
m_job_id = "1590418"  ## From MSV 
...
# with open(f'JobID_{m_job_id}_AS.csv', mode='w', encoding="utf-8") as csv_file:
    ...
    csv_header_names = ["Action_ID", "Action_Name", "Action_Description",  # Headers for CSV Document
                        "Detected", "Prevented", "SecTech_Component"
                        ]
...
#     json.dump(job_raw_data, outfile)
    ...
    for i in job_steps_data:  
        ...
        for j in job_action_data:
            ...
            sampledata = summary, action_Name, action_description, res_detected, res_blocked, sectech_component
